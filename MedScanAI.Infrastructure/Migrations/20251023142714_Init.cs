        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientCurrentMedications_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportFileUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AIReports_Appointments_AppointmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "تشخيص وعلاج أمراض الجلد والشعر والأظافر", "الأمراض الجلدية" },
                    { 2, "تشخيص وعلاج أمراض واضطرابات الدماغ والجهاز العصبي", "طب الأعصاب" },
                    { 3, "تشخيص وعلاج أمراض الجهاز التنفسي والرئتين", "أمراض الصدر" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIChatSessions_StartedAt",
                table: "AIChatSessions",
                column: "StartedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AIReports_AppointmentId",
                table: "AIReports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientCurrentMedications_PatientId",
